...
// 7. Escriba un programa de JavaScript que itera enteros del 1 al 100.
// Pero para múltiplos de tres, imprima "Fizz" en lugar del número y para
// múltiplos de cinco imprima "Buzz". Para números múltiplos de tres y
...
// calificación es inferior a 6, “regular” si está entre 6 y 8, “bien” si
// es 9, y por último, “excelente” si es 10.

//Respuesta:
const nota = parseInt(prompt("Ingrese una calificación (1-10):"));
console.log("Nota: " + nota)
if (nota < 1 || nota > 10) {
    console.log("Error: la calificación debe estar entre 1 y 10");
} else if (nota < 6) console.log("Reprobado");
else if (nota <= 8) console.log("Regular");
else if (nota === 9) console.log("Bien");
